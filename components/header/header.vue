<template>
    <v-card class="header">
      <v-toolbar color="cyan" dark flat>
        <div>
          <v-toolbar-title >
            <div class="logo" /> <!-- แสดง logo สินค้า -->
          </v-toolbar-title>
        </div>

        <!-- มันเป็นค่า array ต้องระบุตำแหน่งแล้วก็เจาะจงลงไป -->
        <div v-if="$auth.loggedIn"><!-- ถ้ามีการ login  -->
          <div class="login">
            ...
            <v-dialog v-model="dialog" persistent max-width="350">
              ...
              <v-card>
                <v-card-title>ท่านต้องการออกจากระบบใช่หรือไม่?</v-card-title> <!-- เช็คก่อนออกจากระบบ -->
                <v-card-actions>
                  <v-spacer></v-spacer>
        ...
        <div v-else>
          <div class="right"> <!-- ปุ่มเมนูบาร์ต่างๆ -->
            <v-btn
             color="white"
              text
